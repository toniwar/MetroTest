...
let a1 = ["questions.json", "answers.json", "check.json"], ran, flag = 0, quest, answer = [], check = [], index, res = [], ball = 0, min = 0, max = 739, store = [], answered = 0, right = 'Правильный ответ: <br><br>', your = 'Ваш ответ: <br><br>', trueAns = [], yourAns = [];
...
trueAns[flag] = document.createElement('div');
trueAns[flag].style = `width: 50%; background: white; border: 1px solid; text-align: center; padding: 1%`;

yourAns[flag] = document.createElement('div');
yourAns[flag].style = `width: 50%; border: 1px solid; text-align: center; padding: 1%; background: palegreen`;

block.append(trueAns[flag]);
block.append(yourAns[flag]);
ls = item;
rs = item;
trueAns[flag].innerHTML = right + item.innerHTML;
yourAns[flag].innerHTML = your + item.innerHTML;
...
yourAns[flag] = document.createElement('div');
yourAns[flag].style = `width: 50%; border: 1px solid; text-align: center; padding: 1%; background: tomato`;
